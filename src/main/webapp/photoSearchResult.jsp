...
<body>
	<%
		Student p = (Student)request.getSession().getAttribute("photoSearchPerson");
		String imgUrl = "http://localhost:8080/hw_maven_war/img/"+p.getId()+".jpg";
        ...
        <table id="info_table" class="table table-hover table-bordered">
            ...
            <tbody>
           		<tr>
                    ...
                    <td>${photoSearchPerson.gender }</td>
                    <td>${photoSearchPerson.grade }</td>
            		<td>${photoSearchPerson.mobile }</td>
            		<td>${photoSearchPerson.email }</td>
            		<td><img style="height: 100px;width: 80px;"  src="${imgUrl}"></td>
            		<td>
                ...
                <div class="modal-body">
                    ...
                    <form role="form" action="${pageContext.request.contextPath }/modifyInfoServlet" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="gender" name="gender" class="form-control" type="text" placeholder="修改后的性别" value="${photoSearchPerson.gender }">
                        </div>
                        <div class="form-group">
                            <label class="control-label">班级</label>
                            <input id="grade" name="grade" class="form-control" type="text" placeholder="修改后的班级" value="${photoSearchPerson.grade }">
                        </div>
                        <div class="form-group">
                            <label class="control-label">电话</label>
                            <input id="mobile" name="mobile" class="form-control" type="text" placeholder="修改后的电话" value="${photoSearchPerson.mobile }">
                        </div>
                        <div class="form-group">
